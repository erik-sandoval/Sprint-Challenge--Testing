...
Describe, describes the entire function. It on the other hand, only describes a task you want it to test.

1. What is the point of `Test Driven Development`? What do you think about this approach?
The purpose of TDD is to start off w/ small minimal testing, then build off of that with more complex testing as you think of new ways to test your app.

1. Mention three types of automated tests.

Unit test, integration testing, and E2E testing. 
